...
//	ticktingNo로 payment 가져오는 method
	@RequestMapping(value = "/payment/json/getPaymentbyTicketingNo/{ticketingNo}", method = RequestMethod.GET)
...
//	purchaseNo로 payment 가져오는 method
	@RequestMapping(value = "/payment/json/getPaymentbyPurchaseNo/{purchaseNo}", method = RequestMethod.GET)
