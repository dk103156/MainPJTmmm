...
public interface EventDao {
	...
	public Map<String, Object> getPreviewListAd(Search search) throws Exception; //page 필요해서 Map 리턴할래
	...
	public Map<String, Object> getQuizListAd(Search search) throws Exception; //page 필요해서 Map 리턴할래
