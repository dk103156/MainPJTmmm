...
<body>
	...
	<!-- ToolBar End /////////////////////////////////////-->
 	...
 	<!--  화면구성 div Start /////////////////////////////////////-->
 	<div class="container">
 		<h1 class="bg-light text-dark" >상 품 등 록</h1>
 		<hr>
 		<br/>
		...
		<div class="form-group">
			...
			<label for="prodPrice" class="col-sm-2 control-label">상품가격</label>
 				<div class="col-sm-4">
 					<input type="text" class="form-control" id="prodPrice" name="prodPrice" placeholder="상품 가격을 입력해주세요." >
 				</div>
			...
			<label for="prodDetail" class="col-sm-2 control-label">상품구성</label>
 				<div class="col-sm-4">
 					<input type="text" class="form-control" id="prodDetail" name="prodDetail" placeholder="상품 설명을 입력해주세요." >
 				</div>
