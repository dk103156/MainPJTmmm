...
<!-- 			<li id="tabDesc">관리자 문의내역 관리</li> -->
	...
	<div class="board-list-util mb10">
		...
		<div class="board-search ml07">
			<input type="text" title="검색어를 입력해 주세요." placeholder="검색어를 입력해 주세요."name="searchKeyword" class="input-text" id="searchTxt" value="">
