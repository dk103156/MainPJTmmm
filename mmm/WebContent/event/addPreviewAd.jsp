	...
	<br>
 	...
 	<div class="row">
			...
			<div class="col-sm-8">
				...
				<input placeholder="Selected date" type="text" name="previewStartDate" class="form-control col-md-5 col-xs-5 datepicker">                    
					<div class="input-group-addon pinkstyle">
                	<i class="far fa-calendar-alt"></i>
              		</div>			
				</div>	
				...
				<td><div class='input-group date' data-provide="datepicker">
				 <input placeholder="Selected date" type="text" name="previewEndDate" class="form-control col-md-5 col-xs-5 datepicker">                    
				 <div class="input-group-addon pinkstyle">
                  <i class="far fa-calendar-alt"></i>
           		  </div>			
				</div>
		...
		<div class="text-center">
			<button id="regBtn" class="btn btn-dafault write">등&nbsp;록</button>
