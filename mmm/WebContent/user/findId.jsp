				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="modal-footer">
							...
							<a href="/main/main"><button type="button" class="button large purple" style=" border-radius: 4px; color:#333; height: 46px;  border: 0; background-color:#fee50e; color: #333; ">메인화면으로 이동</button></a>
						</div>
					</div>
				</div>
			</div>
